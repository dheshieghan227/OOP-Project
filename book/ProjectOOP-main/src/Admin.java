...
class Admin extends User {
    ...
    public static void manageBookOperation(Book b, int option, int roleID,Vector<Book> books) throws IOException{
        switch (option) {
            case 1:
    ...
    protected int viewMenu(){
        ...
        }while(option < 1 || option > 9);  // Corrected the validation loop condition here!
        return option;
    }
}