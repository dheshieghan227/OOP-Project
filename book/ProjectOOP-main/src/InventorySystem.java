...
public class InventorySystem {
    public static void main(String[] args) throws IOException {
        ...
        if(choice == 1 || choice ==3){
            if(choice ==1){
                ...
                Book b = new Book();
                Vector<Book> books = b.getBooksfromFile(); //initialize books array here
                User realUser = new Admin(user.getUserID(), user.getUserName(), user.getPassword(), user.getEmail(), user.getUserRole(), user.getName().getfName(), user.getName().getlName(), books);


                if (realUser instanceof Admin) { // Check if realUser is an Admin
                    ...
                    do {
                        ...
                        switch (userOption) {
                            ...
                            case 5:
                                ...
                                break;
                            case 6:
                                int val = manageMenu(realUser.getUserRole(), ((Admin)realUser).getBooks());
                                if(val == 9){
                            ...
                            case 7:
                                ...
                                break;
                            case 8:
                                ((Admin) realUser).viewAllCustomers(new Customer()); // This line is now safe
                                break;
                            case 9:
                                System.exit(0);
                                break;
            ...
            if(choice == 1){
                ...
                if (realUser instanceof Customer) {
                    do {
                        scan.nextLine();
                        userOption = realUser.viewMenu();
                        switch (userOption) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                Customer.updateCustomerAcc(realUser);
                                scan.nextLine();
                                break;
                            case 4:
                                //generate report
    ...
    //basic place holder for generate report
    public static void generateReport(String userType) {
        System.out.println("\nGenerating " + userType + " Report...");
        System.out.println("-------------------------------------");
        System.out.println("This is a placeholder for a real report.");
        System.out.println("Detailed report data would be displayed here.");
        System.out.println("-------------------------------------");
        System.out.println("Report generation complete.\n");
    }
    public static int manageMenu(int roleID, Vector<Book> books) throws IOException{
        int option;
        Scanner scan = new Scanner(System.in);
        do {
            System.out.print("\033[H\033[2J");
        ...
        if(option == 4){
            ...
            Admin.manageBookOperation(bk, option, roleID,books);
            return option;
        }
